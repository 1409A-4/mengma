...
$(function() {
	...
	/* 头部搜索 */
	requirejs(['web_qui_quiautocomplete','http://zworld.qyerstatic.com/web/project/headfoot/js/new-header-tpl.js'], function(QuiAutoComplete,tpl) {
		...
		function getHotList() {
			var ary = [];
			ary.push('<li><a href="http://z.qyer.com/all_0_0_14_0_0_0_0/?_channel=freetour&_type=place&keyword=日本" data-bn-ipg="zsj-search-hot"><em>热门搜索</em><span class="name">日本</span></a></li>');
			ary.push('<li><a href="http://z.qyer.com/all_0_0_215_54_0_0_0/?_channel=freetour&_type=place&keyword=清迈" data-bn-ipg="zsj-search-hot"><em>热门搜索</em><span class="name">清迈</span></a></li>');
			ary.push('<li><a href="http://z.qyer.com/all_0_0_0_0_9_0_0/?_channel=freetour&_type=theme&keyword=海岛" data-bn-ipg="zsj-search-hot"><em>热门搜索</em><span class="name">海岛</span></a></li>');
			ary.push('<li><a href="http://z.qyer.com/flights/all_0_0_186_0_0_0_0/?_channel=freetour&_type=channel&keyword=法国" data-bn-ipg="zsj-search-hot"><em>热门搜索</em><span class="name">法国</span></a></li>');
			ary.push('<li><a href="http://z.qyer.com/cityfun/citypass_0_0_11_11186_0_0_0/?_channel=cityfun&_type=channel&keyword=台湾" data-bn-ipg="zsj-search-hot"><em>热门搜索</em><span class="name">台湾</span></a></li>');
			ary.push('<li><a href="http://z.qyer.com/all_0_0_233_0_0_0_0/?_channel=freetour&_type=place&keyword=韩国" data-bn-ipg="zsj-search-hot"><em>热门搜索</em><span class="name">韩国</span></a></li>');
			return ary;
		}
		...
		if(window.location.href.search('http://z.qyer.com/visa')==-1){
			var page = {
