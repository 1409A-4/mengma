...
<head>
    ...
    <title>自由行</title>
    <meta name="keywords" content="自由行">
    <meta name="description" content="自由行">
    <base href="{{URL::asset('/')}}"/>
    @include('index.public.style')


    <script src="info_files/ga" async="" type="text/javascript"></script>
    <script src="info_files/adw.js" async="" type="text/javascript"></script>
    <script>
        window.QYER = {};
        window.QYER.uid = 0;
    </script>

    <link rel="stylesheet" type="text/css" href="info_files/iconfont.css">
    <link rel="stylesheet" href="info_files/frame_css.css">
    <link rel="stylesheet" href="info_files/detail6_css.css">

    <script src="info_files/jquery.js" type="text/javascript"></script>
    <script>
        $(function () {
            $('#min').click(function () {
                alert(123);
    ...
    <link href="info_files/translator.css" id="SL_Style" type="text/css" rel="stylesheet">

    <link href="info_files/share.css" rel="stylesheet" type="text/css">
  ...
  >
    ...
    <link href="info_files/QuiAutoComplete.css" rel="stylesheet" type="text/css">
</head>

<body>
<link type="text/css" rel="stylesheet" href="info_files/jiathis_share.css">
<iframe style="position: fixed; display: none; opacity: 0;" frameborder="0"></iframe>
<div style="position: absolute; z-index: 1000000000; display: none; top: 50%; left: 50%; overflow: auto;" class="jiathis_style"></div>
<div style="position: absolute; z-index: 1000000000; display: none; overflow: auto;" class="jiathis_style"></div>
<iframe src="info_files/jiathis_utility_002.htm" style="display: none;" frameborder="0"></iframe>
<link type="text/css" rel="stylesheet" href="info_files/jiathis_share.css">
<iframe style="position: fixed; display: none; opacity: 0;" frameborder="0"></iframe>
<div style="position: absolute; z-index: 1000000000; display: none; top: 50%; left: 50%; overflow: auto;" class="jiathis_style"></div>
<div style="position: absolute; z-index: 1000000000; display: none; overflow: auto;" class="jiathis_style"></div>
<iframe src="info_files/jiathis_utility_002.htm" style="display: none;" frameborder="0"></iframe>
<div style="left: 1194.5px; right: auto; top: 537px; display: block;" class="ui_upward_wrapper" id="ui_gotop">
    <div class="ui_upward_icon">回页顶</div>
</div>
...
<script type="text/javascript">
    ...
    var myContact = null;
    var linkTopic = false;
    var pdLimitDay = {national_day:0};
    var is_sfy = '0';
    var supplier_id = '1818';
</script>
<div class="lmMain">
    <div class="grand-title clearfix">
        <h1 style="visibility: visible;" class="title-text fontYaHei">【中秋/国庆】上海直飞长白山4天3晚自由行(赠接送机+4-5星酒店可选)</h1>
        <p class="normal-price">
            <span class="former-price">¥3299</span>
            <span class="after-price"><em>899</em>元起</span>
        </p>
    </div>
    <!-- 表单  -->
    <form id="lastminuteorderform" name="lastminuteorderform" action="/orderformconfirm" method="POST">
        <div class="top-section clearfix">
            <div class="left-tuwen">
                <div class="gallery">
                    <!--<p class="countdown"><span class="qui-icon-clock"></span> 3天9小时后结束</p> -->
                    <!--<p class="countdown"><span class="qui-icon-clock"></span> 2014年12月21日结束</p> -->
                    ...
                    <div class="scroll-unit">
                        <div data-canslide="false" class="img-scroll clearfix">
                            <div class="scroll-cell"><img src="info_files/420x280.jpg"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="content-wrap">
                    <div class="content-unit product-option">
                        ...
                        <div class="unit-nr">
                            <ul class="type-list clearfix" data-orheight="144">
                                <li class="" data-pid="219425" data-type="1" data-bn-ipg="lm-detail-type-219425"><p title="四星宜必思尚品（晚航班）">四星宜必思尚品（晚航班）</p>
                                </li>
                                <li class="first active" data-pid="219411" data-type="1" data-bn-ipg="lm-detail-type-219411"><p title="四星宜必思尚品（早航班）">四星宜必思尚品（早航班）</p>
                                </li>
                    ...
                    <div class="content-unit lm-calendar">
                        <h4 class="unit-title">出发日期
                            <span class="title-desc">2016/09/12 13点整</span>
                    ...
                    <div class="content-unit person-number">
                        ...
                        <div class="unit-nr">
							...
							<span class="mun-text">人数</span>
                                        ...
                                        <input data-tiptype="stock" id="num-adult" class="num-input" value="1"
                                               data-min="" data-max="" type="text">
                                ...
                                <!-- <li>
                                     <p class="num-p">
                                         <span class="mun-text">儿童<em>(&nbsp;2-12周岁)</em></span>
                                         <a class="num-btn minus disable" href="javascript:void(0);">
                                             <span class="qui-icon-minus-reverse"></span>
                                         </a>
                                         <input id="num-children" class="num-input" type="text" value="0" data-min="0" data-max="0" />
                                         <a class="num-btn add" href="javascript:void(0);">
                                             <span class="qui-icon-plus-reverse"></span>
                                         </a>
                                     </p>
                                 </li>
                                ...
                                <li style="display: list-item;">
                                    <p class="num-p">
                                        ...
                                        <a class="num-btn minus" href="javascript:void(0);">
                                            <span class="qui-icon-minus-reverse"></span>
                                        </a>
                                        <input data-tiptype="stock" id="num-room" class="num-input" value="3" data-min="2" data-max="3" type="text">
                                        <a class="num-btn add disable" href="javascript:void(0);">
                                            <span class="qui-icon-plus-reverse"></span>
                                        </a>
                                    </p>
                                </li>
                                <span class="num-tip" style="left: 189.5px; display: none;"><i class="qui-icon-tip-info-reverse"></i>不能大于出行人数</span>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="booking-unit">
                        ...
                        <div class="book-cell enable clearfix">
                            <div class="price-unit">
                                <span class="price">¥<em class="fontYaHei">6297</em></span>
                                <div class="room-offset" style="display: inline;">
                                    <span>含<em class="single-room-offset">1800</em>元单房差</span>
                            ...
                            <input id="booking" class="book-btn book-now fontYaHei enable" data-bn-ipg="lm-detail-booking-main" value="立即预订" type="button">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="detail-content-wrap">
        ...
        <strong>请注意：多程机票需严格按行程顺序使用，如任意一段未使用则后续航段均无法使用。</strong>
                ...
                <script type="text/javascript">
                    var lid = 79807;
                    function question_page(page){
                        $.post("/index.php?action=getQuestionAjaxPage",{lid:lid,page:page},function(data){
                    ...
                    $(function(){
                        requirejs([''], function(){
                            var $textarea = $("#textarea"),
                                    $textarea_tip = $("#textarea-tip");

                            $textarea.qyerTextArea({'min':10, 'max':140});

                            $textarea.click(function(){
                                $textarea_tip.hide();
                            })
                            $("#mod_talk_sub").click(function(){
                                var content_is_valid = $textarea.qyerTextArea('isValidate'),
                                        content = $textarea.qyerTextArea('getValue');
                                ...
                                $.post("/index.php?action=addQuestion",{lid:lid,content:content},function(re){
                                    requirejs(['common/models/common/ui/tip/tip'], function(tip){
                                        if(re.error_code == 0){
                                            if (re.data.status == 1) {
                                                tip.tip({
                                                    text:'发布成功！'
                                            ...
                                            $("#question_list").html(re.data.html);
                                            $textarea.qyerTextArea('setValue','');
                                        }else{
                                            tip.tip({
                                                text:re.data?re.data.msg:'未知错误',
                                                type:'error'
                                            })
                                        }});
                                },"json");
...
<style type="text/css">
    .setBigImgViewModule img{cursor:pointer;}
</style>
<script>
    //@devil 150829 参考行程 大图展示
    (function($){
        var imgBox = $(".setBigImgViewModule"),
                imgAry = imgBox.find("img:not(.detail-video-placeholder)"), // 去掉video默认占位图
                imgAryLength = imgAry.length;
        if(imgAryLength){
            require(['common/models/common/ui/popImgBox3/popImgBox'],function(){
                imgAry.each(function(key){
                    var index = key+1,
                            total = imgAryLength,
                            bigsrc = $(this).attr("src").replace(/\/w1080$/,""),
                            owner = '',
                            source = '';
                    $(this)
                ...
                // 全局共用一个幻灯片
                $(document).popImgBox({
                    selector:".setBigImgViewModule img:not(.detail-video-placeholder)",
                    closeCallback:function(){},
                    prevBtnCallback:function(aEl,aData,aIndex){},
                    nextBtnCallback:function(aEl,aData,aIndex){},
                    beyondRange:function(aEl,aData,aIndex){}
                });
            });
        }
    })(jQuery);
    //end @devil 150829 参考行程 大图展示
</script>
...
<script src="info_files/frame_js_btm.js"></script>
