            ...
            <div class="col-md-12">
                <div class="panel panel-blue">
                    ...
                    <div class="panel-body pan">
                        ...
                        @endif
                        <form action="admin/goodsEdit" method="post" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="form-body pal">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-icon"><i class="fa fa-indent"></i>
                                            <input id="inputUsername" type="text" placeholder="商品名称" value="{{$goods['gname']}}" name="gname" class="form-control" />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-icon"><i class="fa fa-indent"></i>
                                            <input id="inputUsername" type="text" placeholder="商品价格" value="{{$goods['gprice']}}"name="gprice" class="form-control" />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-icon"><i class="fa fa-indent"></i>
                                            <input id="inputUsername" type="text" placeholder="商品库存" value="{{$goods['gstock']}}" name="gstock" class="form-control" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group " >
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-icon"><i class="fa fa-indent"></i>
                                            <input  type="text" placeholder="商品地区" id="gaddress" name="gaddress" value="{{$goods['gaddress']}}" class="form-control" />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <textarea id="inputContent" rows="3" class="form-control" name="ghome">{{$goods['ghome']}}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
