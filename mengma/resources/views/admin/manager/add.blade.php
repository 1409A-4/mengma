            ...
            <div class="col-md-12">
                <div class="panel panel-blue">
                    ...
                    <div class="panel-body pan">
                        <form action="admin/managerAdd" method="post" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="form-body pal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-icon"><i class="fa fa-indent"></i>
                                            <input id="inputUsername" type="text" placeholder="邮箱" name="uemail" class="form-control" />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
