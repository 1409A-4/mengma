            ...
            <div class="col-md-12">
                <div class="panel panel-blue">
                    ...
                    <div class="panel-body pan">
                        <form action="admin/role/{{$data->rid}}" method="post" class="form-horizontal">
                            <input type="hidden" name="_token" value="{{csrf_token()}}">
                            {{ method_field('PUT') }}
                            <div class="form-body pal">
                                <div class="form-group">
                                    <label for="inputUsername" class="col-md-3 control-label">角色名称 <span class='require'>*</span>
                                    </label>
                                    <div class="col-md-9">
                                        <div class="input-icon"><i class="fa fa-indent"></i>
                                            <input id="inputUsername" type="text" placeholder="角色名称" name="rname" value="{{$data->rname}}" class="form-control" />
                                        </div>
                                    </div>
                                </div>
