            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" role="form" method="post" action="business/goodsAdd_pro"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    col-md-2"></select>
                                    <select name="city" id="s_city" class="validate[required] col-md-2"></select>
                                    <select name="county" id="s_county" class="validate[required] col-md-2"></select>
                                </div>
                            </div>
