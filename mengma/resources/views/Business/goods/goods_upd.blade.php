...
<body>
@include('business.public.navbar')
...
<div class="main-container" id="main-container">
    ...
    <div class="main-container-inner">
        ...
        @include('business.public.sidebar')
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        @endif
                        <span style="color: red">{{ empty(session('gmag'))?'':session('gmag')}}</span>
                        <form class="form-horizontal" role="form" method="post" action="business/goodsUpd"
                              id="form_id" enctype="multipart/form-data">
                            <input type="hidden" name="_token" value="{{ csrf_token()}}">
                            <input type="hidden" name="h_id" value="{{ $info['h_id']}}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <select name="hc_id" >
                                        ...
                                        @foreach($type as $ty)
                                            @if($ty['hc_id']==$info['hc_id'])
                                                <option value="{{ $ty['hc_id'] }}" selected>{{ $ty['hc_name'] }}</option>
                                                @else
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="h_price" id="form-field-1" placeholder="房间价格"  value="{{$info['h_price']}}"
                                           class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="h_stock" id="form-field-1" placeholder="房间数量" value="{{$info['h_stock']}}"
                                           class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
