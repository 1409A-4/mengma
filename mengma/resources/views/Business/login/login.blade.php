                ...
                <fieldset>
                    <label class="block clearfix">
                       <span class="block input-icon input-icon-right">
                           <input type="text" class="form-control validate[required]" name="bname" placeholder="商号" />
                                    <i class="icon-user"></i>
                       </span>
                    </label>
...
<div id="signup-box" class="signup-box widget-box no-border">
    <div class="widget-body">
        <div class="widget-main">
            ...
            <form id="form_register" action="business/add" method="post" enctype="multipart/form-data">
                <input type="hidden" name="_token" value="{{csrf_token()}}">
                <fieldset>

                    <label class="block clearfix">
                                <span class="block input-icon input-icon-right">
                                    <input type="text" name="bname" class="form-control validate[required,custom[chinese],minSize[2]]" placeholder="商号" />
                                    <i class="icon-dashboard"></i>
                                </span>
                    </label>
                    <label class="block clearfix">
                    <div>
                        <textarea class="form-control validate[required,custom[chinese],minSize[5],maxSize[30]]" name="bdescribe" id="form-field-8"
                                  placeholder="商号描述"></textarea>
                    </div>
                        </label>
                    ...
                    <label class="block clearfix">
                                <span class="block input-icon input-icon-right">
                                    ...
                                    validate[required,custom[chinese],minSize[2],maxSize[4]]"
                                           placeholder="真实姓名" />
                                    <i class="icon-user"></i>
                                </span>
                    </label>
                    <label class="block clearfix">
                                <span class="block input-icon input-icon-right">
                                    ...
                                    validate[required,custom[chinaId]]"
                                           placeholder="身份证号" />
                                    <i class="icon-edit"></i>
                                </span>
                    </label>
                    <label class="block clearfix">
                                <span class="block input-icon input-icon-right">
                                    <input type="text" name="bemail" class="form-control
                    ...
                    <label class="block clearfix">
                                <span class="block input-icon input-icon-right">
                                    ...
                                    validate[required,custom[m_phone]]"
                                           placeholder="手机" />
                                    <i class="icon-hdd"></i>
                                </span>
                    </label>
                    ...
                    <label class="block clearfix">
                                <span class="block input-icon input-icon-right">
                                    <input type="password" name="bpwd" id="bpwd"
                                           class="form-control
                                    validate[required]"
                                           placeholder="密码" />
                                    <i class="icon-lock"></i>
                    ...
                    <label class="block clearfix">
                        ...
                        <input type="file" name="blicence" class="validate[required]">
                            </span>
                    </label>
                    <label class="block clearfix">
                        <select name="province" id="s_province" class=" validate[required] col-md-4"></select>
                        <select name="city" id="s_city" class="validate[required] col-md-4"></select>
