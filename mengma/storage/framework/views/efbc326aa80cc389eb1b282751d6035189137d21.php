...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/02ddd074ab258887bea4f98d71d32b7f.css">
    <link rel="stylesheet" href="css/jquery.cxcalendar.css">
    <link rel="stylesheet" href="info_files/frame_css.css">

    <link rel="stylesheet" type="text/css" href="css/index.5b07d9dd456b809db030b241ed486e97.css">
...
<div class="zw-wrapper zw-order-container clearfix">
    ...
    <div class="aside">
        <div class="mod-wrapper">
            ...
            <div class="mod" data-mod-id="order" data-mod-price="30598">
                <div class="mod-head">
                    <strong class="mod-prod-name"><?php echo e($data['p_abstract']); ?></strong>
                </div>
                <div class="mod-content">
                    <div class="clearfix">
                        <strong class="mod-prod-model"><?php echo e($data['p_name']); ?></strong>
                    </div>
                    ...
                    <ul class="mod-prod-items">
                        <li class="mod-prod-item">
                            ...
                            <em class="item-cost">
                                ￥<em class="price fontNum"><?php echo e($data['ht_price']); ?></em><em class="x fontNum">x</em><em class="num fontNum" id="nump"><?php echo e($data['nump']); ?></em>
                            </em>
                        </li>
                        <?php if($data['numr']* 2 -$data['nump']==0): ?>
                        <?php else: ?>
                            <li class="mod-prod-item">
                                ...
                                <em class="item-cost">
                                    ...
                                    <em class="num fontNum"><?php echo e($data['numr']* 2 -$data['nump']); ?></em>
                                </em>
                            </li>
                        <?php endif; ?>
                    </ul>
                    ...
                    <div class="mod-prod-price clearfix">
                        ...
                        <span class="mod-prod-price-value">￥
                            <em class="price fontNum"><?php echo e($data['ht_price'] *  $data['nump'] +  ($data['numr']* 2 -$data['nump'])* 300); ?></em>
                        </span>
                    </div>
                </div>
            </div>
    ...
    <div class="main">
        ...
        <form id="form" action="packageBuy" method="POST">
            <input type="hidden"  name="_token" value="<?php echo e(csrf_token()); ?>">
            <input type="hidden"  name="p_id" value="<?php echo e($data['p_id']); ?>">
            <input type="hidden"  name="ht_id" value="<?php echo e($data['p_type']); ?>">


            <div class="mod-wrapper">
                <div class="zw-notlogin">
                    <div class="zw-notlogin-no">
                        <span class="notlogin-ico"></span>
                        <span class="notlogin-text"><a href=''>登录</a>购买，参与更多优惠活动</span>
                    </div>
                    <div class="zw-notlogin-yes">
                        <span class="notlogin-text">已使用<span class="notlogin-text-span"></span>手机号注册的账号登录</span>
                    </div>
                </div>
                <div class="zw-haslogin">
                ...
                <div class="mod mod-prople" data-mod-id="tourist" data-mod-name="旅客信息" data-mod-num="2">
                    ...
                    <div class="mod-content">
                        <ul class="mod-unit mod-tourists">
                            <?php for($i=1;$i<=$data['nump'];$i++): ?>
                                <li class="mod-tourist mod-people-li">
                                    <div class="mod-title">
                                        <span class="zwui-iconfont icon-user mod-ico"></span><span class="vm">旅客<?php echo e($i); ?></span></div>
                                    <ul class="mod-fields clearfix">
                                        ...
                                        <li class="mod-field size1" data-fetype="input" data-name="中文姓" data-id="firstname">
                                            <div class="input-ribbon" data-key="tourist_firstname" data-fetype="input" data-name="中文姓" data-id="firstname" data-required="true" data-pattern="^[\u2E80-\u9FFF]{1,10}$">
                                                ...
                                                <div class="input-text">
                                                    <input type="text" name="tourist_firstname[<?php echo e($i); ?>]" id="tourist_firstname-0" placeholder="例李雷填李（同证件）">
                                                </div>
                                                <label for="tourist_firstname[<?php echo e($i); ?>]" class="input-hint">
                                                    <div class="null">请填写中文姓</div>
                                                    <div class="error">请重新填写</div>
                                                </label>
                                            </div>
                                        </li>
                                        ...
                                        <li class="mod-field size1" data-fetype="input" data-name="中文名" data-id="lastname">
                                            <div class="input-ribbon" data-key="tourist_lastname" data-fetype="input" data-name="中文名" data-id="lastname" data-required="true" data-pattern="^[\u2E80-\u9FFF]{1,10}$">
                                                ...
                                                <div class="input-text">
                                                    <input type="text" name="tourist_lastname[<?php echo e($i); ?>]" id="tourist_lastname-0" placeholder="例李雷填雷（同证件）">
                                                </div>
                                                <label for="tourist_lastname[0]" class="input-hint">
                                                    <div class="null">请填写中文名</div>
                                                    <div class="error">请重新填写</div>
                                                </label>
                                            </div>
                                        </li>
                                        ...
                                        <li class="mod-field size1" data-fetype="input" data-name="拼音姓" data-id="firstname_en">
                                            <div class="input-ribbon" data-key="tourist_firstname_en" data-fetype="input" data-name="拼音姓" data-id="firstname_en" data-required="true" data-pattern="^[a-zA-Z\.]+$">
                                                ...
                                                <div class="input-text">
                                                    <input type="text" name="tourist_firstname_en[<?php echo e($i); ?>]" id="tourist_firstname_en-0" placeholder="例李雷填LI（同证件）">
                                                </div>
                                                <label for="tourist_firstname_en[0]" class="input-hint">
                                                    <div class="null">请填写拼音姓</div>
                                                    <div class="error">请重新填写</div>
                                                </label>
                                            </div>
                                        </li>
                                        ...
                                        <li class="mod-field size1" data-fetype="input" data-name="拼音名" data-id="lastname_en">
                                            <div class="input-ribbon" data-key="tourist_lastname_en" data-fetype="input" data-name="拼音名" data-id="lastname_en" data-required="true" data-pattern="^[a-zA-Z\.]+$">
                                                ...
                                                <div class="input-text">
                                                    <input type="text" name="tourist_lastname_en[<?php echo e($i); ?>]" id="tourist_lastname_en-0" placeholder="例李雷填LEI（同证件）">
                                                </div>
                                                <label for="tourist_lastname_en[0]" class="input-hint">
                                                    <div class="null">请填写拼音名</div>
                                                    <div class="error">请重新填写</div>
                                                </label>
                                            </div>
                                        </li>
                                                ...
                                                <div class="input-text">
                                                    <div class="custom-multi-radio clearfix">
                                                        <div class="custom-radio">
                                                            <input type="radio" id="tourist_sex_1-<?php echo e($i); ?>" name="tourist_sex[<?php echo e($i); ?>]" data-name="男" value="1">
                                                            <label class="fixed_radio" for="tourist_sex_1-<?php echo e($i); ?>"></label>
                                                            <label for="tourist_sex_1-<?php echo e($i); ?>">男</label>
                                                        </div>
                                                        <div class="custom-radio">
                                                            <input type="radio" id="tourist_sex_2-<?php echo e($i); ?>" name="tourist_sex[<?php echo e($i); ?>]" data-name="女" value="2">
                                                            <label class="fixed_radio" for="tourist_sex_2-<?php echo e($i); ?>"></label>
                                                            <label for="tourist_sex_2-<?php echo e($i); ?>">女</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <label for="tourist_sex-0" class="input-hint">
                                                    <div class="null">请选择性别</div>
                                                    <div class="error">请重新选择</div>
                                                </label>
                                            </div>
                                        </li>
                                        ...
                                        <li class="mod-field size1" data-fetype="input_select" data-name="国籍" data-id="nationnality">
                                            <div class="input-ribbon" data-key="tourist_nationnality" data-fetype="input_select" data-name="国籍" data-id="nationnality" data-required="true" data-pattern="^([\u4e00-\u9fa5]|[a-zA-Z])+$">
                                                ...
                                                <div class="input-text">
                                                    <input type="text" data-selectkey="" name="tourist_nationnality[<?php echo e($i); ?>]" id="tourist_nationnality-0" placeholder="选择或填写国家名称">

                                                </div>
                                                <label for="tourist_nationnality-0" class="input-hint">
                                                    <div class="null">请填写国籍</div>
                                                    <div class="error">请重新填写</div>
                                                </label>
                                            </div>
                                        </li>
                                                ...
                                                <div class="input-text">
                                                    <div class="custom-datepicker">
                                                        <label for="tourist_birthday-0">
                                                            <input type="text"
                                                                   name="tourist_birthday[<?php echo e($i); ?>]"
                                                                   id="element_id_<?php echo e($i); ?>"
                                                                   placeholder="选择日期"
                                                                   readonly="readonly"
                                                                   data-max="1474083495"
                                                            >
                                        ...
                                        <li class="mod-field size1" data-fetype="input" data-name="出生地" data-id="birth_place">
                                            <div class="input-ribbon" data-key="tourist_birth_place" data-fetype="input" data-name="出生地" data-id="birth_place" data-required="true" >
                                                ...
                                                <div class="input-text">
                                                    <input type="text" name="tourist_birth_place[<?php echo e($i); ?>]" id="tourist_birth_place-0" placeholder="">
                                                </div>
                                                <label for="tourist_birth_place[0]" class="input-hint">
                                                    <div class="null">例北京</div>
                                                    <div class="error">请填写出生地</div>
                                                </label>
                                            </div>
                                        </li>
                                        ...
                                        <li class="mod-field mod-field-title size4" data-fetype="special" data-name="证件信息" data-id="identity_info">
                                            ...
                                            <div class="field-subtitle">填写说明
                                                <span class="zwui-iconfont icon-info mod-ico"></span>
                                                <div class="tourist-description">
                                                    <h2 class="title">填写说明</h2>
                                                    <p class="subtitle">以中国大陆护照上的位置为例，请严格按照出行时所用证件上的信息填写</p>
                                                    <div class="passport-example new"><strong>新版护照</strong></div>
                                                    <div class="passport-example old"><strong>旧版护照</strong></div>
                                                    <div class="passport-container new"><img src="images/pic-new-passport.png"></div>
                                                    <div class="passport-container old"><img src="images/pic-old-passport.png"></div>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="mod-field size1" data-fetype="select" data-name="证件类型" data-id="identity_type">
                                            <div class="input-ribbon" data-key="tourist_identity_type" data-fetype="select" data-name="证件类型" data-id="identity_type" data-required="true">
                                                ...
                                                <div class="input-text">
                                                    <input type="text"  name="tourist_identity_type[<?php echo e($i); ?>]" >
                                                    <div class="hidden inputAutocomplete-hidden">
                                                        <ul class="qui-inputAutocomplete-ul">
                                                            <li data-key="1" data-value="护照" title="护照">
                            <span class="qyer_inputAutocomplete_name card-type-item">
                                <em>护照</em>
                            </span>
                                                            </li>
                                                            <li data-key="2" data-value="身份证" title="身份证">
                            <span class="qyer_inputAutocomplete_name card-type-item">
                                <em>身份证</em>
                            </span>
                                                            </li>
                                                            <li data-key="3" data-value="港澳通行证" title="港澳通行证">
                            <span class="qyer_inputAutocomplete_name card-type-item">
                                <em>港澳通行证</em>
                            </span>
                                                            </li>
                                                            <li data-key="4" data-value="大陆居民往来台湾通行证" title="大陆居民往来台湾通行证">
                            <span class="qyer_inputAutocomplete_name card-type-item">
                                <em>大陆居民往来台湾通行证</em>
                            </span>
                                                            </li>
                                                            <li data-key="5" data-value="回乡证" title="回乡证">
                            <span class="qyer_inputAutocomplete_name card-type-item">
                                <em>回乡证</em>
                            </span>
                                                            </li>
                                                            <li data-key="6" data-value="台胞证" title="台胞证">
                            <span class="qyer_inputAutocomplete_name card-type-item">
                                <em>台胞证</em>
                            </span>
                                                            </li>
                                                            <li data-key="99" data-value="其他或忘记证件号码" title="其他或忘记证件号码">
                            <span class="qyer_inputAutocomplete_name card-type-item">
                                <em>其他或忘记证件号码</em>
                            </span>
                                                            </li>
                                                ...
                                                <label for="tourist_identity_type-0" class="input-hint">
                                                    <div class="null">请填写证件类型</div>
                                                    <div class="error">请重新填写</div>
                                                </label>
                                            </div>
                                        </li>
                                        <li class="mod-field size1" data-fetype="input" data-name="证件号" data-id="identity_num">
                                            <div class="input-ribbon" data-key="tourist_identity_num" data-fetype="input" data-name="证件号" data-id="identity_num" data-required="true" data-pattern="^[0-9a-zA-Z]+$">
                                                ...
                                                <div class="input-text">
                                                    <input type="text" name="tourist_identity_num[<?php echo e($i); ?>]" id="tourist_identity_num-0" placeholder="">
                                                </div>
                                                <label for="tourist_identity_num[<?php echo e($i); ?>]" class="input-hint">
                                                    <div class="null">请填写证件号</div>
                                                    <div class="error">请重新填写</div>
                                                </label>
                                            </div>
                                        </li>
                                                ...
                                                <div class="input-text">
                                                    <div class="custom-datepicker">
                                                        <label for="tourist_identity_validity-0">
                                                            <input
                                                                    type="text"
                                                                    name="tourist_identity_validity[<?php echo e($i); ?>]"
                                                                    id="tourist_<?php echo e($i); ?>"
                                                                    placeholder=""
                                                                    readonly="readonly"
                                                                    data-min="1474083495">
                                                            <span class="zwui-iconfont icon-calendar mod-ico"></span>
                                        ...
                                        <li class="mod-field size1" data-fetype="input" data-name="签发地" data-id="identity_place">
                                            <div class="input-ribbon" data-key="tourist_identity_place" data-fetype="input" data-name="签发地" data-id="identity_place" data-required="true">
                                                ...
                                                <div class="input-text">
                                                    <input type="text" name="tourist_identity_place[<?php echo e($i); ?>]" id="tourist_identity_place-0" placeholder="">
                                                </div>
                                                <label for="tourist_identity_place[0]" class="input-hint">
                                                    <div class="null">请填写签发地</div>
                                                    <div class="error">请重新填写</div>
                                                </label>
                                            </div>
                                        </li>
                                        ...
                                        <div class="input-ribbon ribbon-bind" data-key="tourist_bind">
                                            <div class="input-text">
                                                <div class="custom-checkbox">
                                                    <input type="checkbox" name="tourist_bind[<?php echo e($i); ?>]" id="tourist_bind[<?php echo e($i); ?>]" value="true" checked="checked">
                                                    <label for="tourist_bind[<?php echo e($i); ?>]" data-bn-ipg="zsj-order-save-traveler"></label>
                                                </div>
                                            </div>
                                            <label class="input-title" for="tourist_bind[<?php echo e($i); ?>]" data-bn-ipg="zsj-order-save-traveler">保存为常用旅客</label>
                                        </div>
                                    </div>
                                </li>
                            <?php endfor; ?>
                                ...
                                <ul class="mod-fields clearfix">
                                    <li class="mod-field size1" data-fetype="input" data-name="姓名" data-id="name">
                                        <div class="input-ribbon " data-key="contacts_name" data-fetype="input" data-name="姓名" data-id="name" data-required="true" data-pattern="^([\u4e00-\u9fa5]|[a-zA-Z])+$">
                                            ...
                                            <div class="input-text">
                                                <input type="text" data-id="name" name="contacts_name" id="contacts_name" placeholder="联系人姓名" value="">
                                            </div>
                                            <label for="contacts_name" class="input-hint">
                                                <div class="null">请填写姓名</div>
                                                <div class="error">请重新填写</div>
                                            </label>
                                        </div>
                                    </li>
                                    <li class="mod-field size1" data-fetype="input" data-name="手机号" data-id="phone">
                                        <div class="input-ribbon country-code" data-key="contacts_phone" data-fetype="input" data-name="手机号" data-id="phone" data-required="true" data-pattern="^\d+$">
                                            ...
                                            <div class="input-text">
                                                ...
                                                <input id="input-phone-code" class="input-phone-code" type="text" data-id="phone" name="contacts_phone" id="contacts_phone" placeholder="用于接收确认信息" value="">
                                            </div>
                                            <label for="contacts_phone" class="input-hint">
                                                <div class="null">请填写手机号</div>
                                                <div class="error">请重新填写</div>
                                            </label>
                                        </div>
                                    </li>
                                    <li class="mod-field size1" data-fetype="input" data-name="邮箱" data-id="email">
                                        <div class="input-ribbon " data-key="contacts_email" data-fetype="input" data-name="邮箱" data-id="email" data-required="true" data-pattern="^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$">
                                            <label class="input-title" for="contacts_email">邮箱</label>
                                            <div class="input-text">
                                                <input type="text" data-id="email" name="contacts_email" id="contacts_email" placeholder="用于接收确认邮件" value="">
                                            </div>
                                            <label for="contacts_email" class="input-hint">
                                                <div class="null">请填写邮箱</div>
                                                <div class="error">请重新填写</div>
                                            </label>
                                        </div>
                                    </li>
                                    <li class="mod-field size1" data-fetype="input" data-name="微信" data-id="wechat">
                                        <div class="input-ribbon " data-key="contacts_wechat" data-fetype="input" data-name="微信" data-id="wechat" data-required="false" data-pattern="">
                                            ...
                                            <label for="contacts_wechat" class="input-hint">
                                                <div class="null">请填写微信号</div>
                                                <div class="error">请重新填写</div>
                                            </label>
                                        </div>
                                    </li>
                ...
                <div class="mod" data-mod-id="price" data-mod-price="30598" data-mod-scene="order">
                    <div class="mod-content">
                        <div class="price-wrapper">
                            ￥<em class="price js-price fontNum"><?php echo e($data['ht_price'] *  $data['nump'] +  ($data['numr']* 2 -$data['nump'])* 300); ?></em><em class="js-coupon"></em>
                        </div>
                        <div class="pay js-submit" data-bn-ipg="zsj-order-pay" data-order-id="" >
...
<script>
    $(function(){
        ...
        var nump = $('#nump').html();
        for (var  i= 1;i<= parseInt(nump);i++) {

            $('#element_id_'+i).cxCalendar();
            $('#tourist_'+i).cxCalendar();
        }
