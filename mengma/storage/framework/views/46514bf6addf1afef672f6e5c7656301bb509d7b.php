...
<div class="u_set_cnt clearfix">
    ...
    <div class="u_set_menu">
        <ul class="fontSong">
            <li data-bn-ipg="usercenter-setting-profile"><a href="<?php echo e(url('index/center')); ?>" class="data">个人资料</a></li>
        ...
        <ul>
            <li data-bn-ipg="usercenter-setting-password" class="current"><a href="<?php echo e(url('index/resetpass')); ?>" class="pass">修改密码</a></li>
    ...
    <div class="u_set_main">
        ...
        <div class="u_set_pass">
            <form action="<?php echo e(url('index/pass_Check')); ?>" method="post"  id="passwordform" >
                <ul class="clearfix">
                    <li>
