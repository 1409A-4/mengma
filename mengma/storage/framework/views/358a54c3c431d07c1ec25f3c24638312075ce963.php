...
<div class="u_set_cnt clearfix">
    ...
    <div class="u_set_menu">
        <ul class="fontSong">
            <li data-bn-ipg="usercenter-setting-profile" class="current"><a href="<?php echo e(url('index/center')); ?>" class="data">个人资料</a></li>
            
        </ul>
        <ul>
           
            <li data-bn-ipg="usercenter-setting-invite"><a href="<?php echo e(url('index/invite')); ?>" class="friend">邀请好友</a></li>
           
        </ul>
        <ul>
            <li data-bn-ipg="usercenter-setting-password" ><a href="<?php echo e(url('index/resetpass')); ?>" class="pass">修改密码</a></li>
        ...
        <div class="u_set_data">
            <ul class="clearfix fontArial">
                <li>
                    ...
                    <div class="right"><?php echo e($u_name); ?>
                ...
                <li>
                    ...
                    <div class="right"><?php echo e($u_phone); ?></div>
                </li>
                <li data-bn-ipg="usercenter-setprofile-living">
                    <div class="left">现居住地：</div>
                    <div class="right"><?php echo e($ip); ?></div>
                </li>
