                    ...
                    <div class="panel-body pan">
                            ...
                            <div class="form-body pal">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <select  class="selectpicker bg-green form-control" name="uid" id="uid">
                                            ...
                                            <?php $__currentLoopData = $admin; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                <option value="<?php echo e($v->uid); ?>"><?php echo e($v->uname); ?></option>
                                ...
                                <div class="form-group" id="roles">
                                    ...
                                    <div class="col-md-9">
                                        <?php $__currentLoopData = $role; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                <input type="checkbox"  name="rid[]" value="<?php echo e($v->rid); ?>" />&nbsp; <?php echo e($v->rname); ?>
