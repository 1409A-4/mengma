...
<head>
    ...
    <script src="info_files/room.js" type="text/javascript"></script>
...
<div class="lmMain">
    <div class="grand-title clearfix">
        <h1 style="visibility: visible;" class="title-text fontYaHei"><?php echo e($data['p_abstract']); ?></h1>
        <p class="normal-price">
            <span class="former-price">¥3299</span>
            <span class="after-price"><em><?php echo e($data['p_price']); ?></em>元起</span>
        </p>
    </div>
    <!-- 表单  -->
    <form id="lastminuteorderform" name="lastminuteorderform" action="packagePro" method="POST">
                ...
                <div class="gallery">
                    ...
                    <div class="scroll-unit">
                        <div data-canslide="false" class="img-scroll clearfix">
                            <div class="scroll-cell"><img src="<?php echo e($data['p_img']); ?>"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="content-wrap">
                    <div class="content-unit product-option">
                        ...
                        <div class="unit-nr">
                            ...
                            <ul class="type-list clearfix" data-orheight="144">
                                <?php $__currentLoopData = $type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ty): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                    <li class="first cli" data-pid="219425" data-type="<?php echo e($ty['ht_id']); ?>" data-bn-ipg="lm-detail-type-219425" >
                                        <p title="四星宜必思尚品（晚航班）" ><?php echo e($ty['ht_name']); ?>（<span><?php echo e($ty['ht_price']); ?></span>元）</p>
                                    </li>
                    ...
                    <div class="booking-unit">
                        ...
                        <div class="book-cell enable clearfix">
                            ...
                            <input id="booking" class="book-btn book-now fontYaHei enable" data-bn-ipg="lm-detail-booking-main" value="立即预订" type="submit">
                        </div>
                    </div>
                </div>
            </div>
