                        ...
                        <div class="panel-body pan">
                            ...
                            <div class="form-body pal">
                                    ...
                                    <div class="col-md-9">
                                        <select  class="selectpicker bg-green form-control" name="rid" id="rid">
                                            ...
                                            <?php $__currentLoopData = $role; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                <option value="<?php echo e($v->rid); ?>"><?php echo e($v->rname); ?></option>
                                ...
                                <div class="form-group" id="roles">
                                    ...
                                    <div class="col-md-9">
                                        <?php $__currentLoopData = $power; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                            <input type="checkbox"  name="pid[]" value="<?php echo e($v->pid); ?>" />&nbsp; <?php echo e($v->pname); ?>
