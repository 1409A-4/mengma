(function (c) {
    ...
    var f;
    var a = function (e) {
        var j = "http://qt.qyer.com/beacon.gif?";
        var i = "qyer.com";
        if (typeof b == "object") {
            if (e != undefined) {
        ...
        m.prototype.visit = function (n) {
            return this._send(f.extend({_type: "visit"}, n || {}))
        };
        m.prototype.link = function (n, p, o) {
            ...
            this._send(f.extend({_type: "link", _url: q}, o));
        ...
        m.prototype.click = function (n) {
            return this._send(f.extend({_type: "click"}, n || {}))
        };
        m.prototype.form = function (n) {
            return this._send(f.extend({_type: "form"}, n || {}))
        };
    ...
    try {
        (function () {
            ...
            function e() {
                ...
                var j = location.href;
                var k = function (l, m) {
                    return new a().click({_campaign: "inpage", _category: l, _ra_arg: m})
                };
                window.qyerTrack = {doTrack: k};
                while (true) {
                    f("a.beacon").on(_event_type, function (m) {
                        ...
                        campaign_id = l.shift();
                        others = l.join("-");
                        return new a().link(f(this), m, {_category: category_id, _campaign: campaign_id, ext: others})
                    });
                    ...
                    f("form").has("input[data-bn-ipg], button[data-bn-ipg]").submit(function (l) {
                        new a().form(f(this), {
                            _campaign: "inpage",
                            _category: f(this).find("input[data-bn-ipg]").attr("data-bn-ipg") || f(this).find("button[data-bn-ipg]").attr("data-bn-ipg")
                        });
                        return true
                    });
                    f("#place_search_input").on("keydown", function (l) {
                        if (l.keyCode == 13) {
                            new a().click({_campaign: "inpage", _category: "59"})
                        }
                    });
                    f("#jn_search_input").on("keydown", function (l) {
                        if (l.keyCode == 13) {
                            new a().click({_campaign: "inpage", _category: "5-0"})
                        }
                    });
                    break
                }
