!function (e, t) {
    ...
    function d(e, t) {
        if (1 === t.nodeType && H.hasData(e)) {
            ...
            if (s) {
                ...
                for (n in s)for (r = 0, i = s[n].length; i > r; r++)H.event.add(t, n + (s[n][r].namespace ? "." : "") + s[n][r].namespace, s[n][r], s[n][r].data)
            }
    ...
    function b(e, t, n) {
        var r = "width" === t ? e.offsetWidth : e.offsetHeight, i = "width" === t ? We : Ie, o = 0, a = i.length;
        if (r > 0) {
            if ("border" !== n)for (; a > o; o++)n || (r -= parseFloat(H.css(e, "padding" + i[o])) || 0), "margin" === n ? r += parseFloat(H.css(e, n + i[o])) || 0 : r -= parseFloat(H.css(e, "border" + i[o] + "Width")) || 0;
            return r + "px"
        }
        if (r = je(e, t, t), (0 > r || null == r) && (r = e.style[t] || 0), r = parseFloat(r) || 0, n)for (; a > o; o++)r += parseFloat(H.css(e, "padding" + i[o])) || 0, "padding" !== n && (r += parseFloat(H.css(e, "border" + i[o] + "Width")) || 0), "margin" === n && (r += parseFloat(H.css(e, n + i[o])) || 0);
        return r + "px"
    }

    function x(e) {
        return function (t, n) {
            if ("string" != typeof t && (n = t, t = "*"), H.isFunction(n))for (var r, i, o, a = t.toLowerCase().split(nt), s = 0, l = a.length; l > s; s++)r = a[s], o = /^\+/.test(r), o && (r = r.substr(1) || "*"), i = e[r] = e[r] || [], i[o ? "unshift" : "push"](n)
        }
    }
    ...
    function N(e, t, n, r) {
        ...
        }); else if (n || null == t || "object" != typeof t)r(e, t); else for (var i in t)N(e + "[" + i + "]", t[i], n, r)
    }
    ...
    H.Callbacks = function (e) {
        e = e ? B[e] || n(e) : {};
        var r, i, o, a, s, l = [], u = [], c = function (t) {
            var n, r, i, o;
            for (n = 0, r = t.length; r > n; n++)i = t[n], o = H.type(i), "array" === o ? c(i) : "function" === o && (e.unique && d.has(i) || l.push(i))
        }, f = function (t, n) {
            for (n = n || [], r = !e.memory || [t, n], i = !0, s = o || 0, o = 0, a = l.length; l && a > s; s++)if (l[s].apply(t, n) === !1 && e.stopOnFalse) {
                r = !0;
                break
            }
            ...
            add: function () {
                ...
                if (l)for (var t = arguments, n = 0, r = t.length; r > n; n++)for (var o = 0; o < l.length && (t[n] !== l[o] || (i && a >= o && (a--, s >= o && s--), l.splice(o--, 1), !e.unique)); o++);
                return this
            }, has: function (e) {
    ...
    H.extend({
        Deferred: function (e) {
            ...
            var r = q.call(arguments, 0), i = 0, o = r.length, a = new Array(o), s = o, l = 1 >= o && e && H.isFunction(e.promise) ? e : H.Deferred(), u = l.promise();
            if (o > 1) {
        ...
        if (!p.addEventListener && p.attachEvent && p.fireEvent && (p.attachEvent("onclick", function () {
                t.noCloneEvent = !1
            }), p.cloneNode(!0).fireEvent("onclick")), a = M.createElement("input"), a.value = "t", a.setAttribute("type", "radio"), t.radioValue = "t" === a.value, a.setAttribute("checked", "checked"), p.appendChild(a), l = M.createDocumentFragment(), l.appendChild(p.lastChild), t.checkClone = l.cloneNode(!0).cloneNode(!0).lastChild.checked, t.appendChecked = a.checked, l.removeChild(a), l.appendChild(p), p.innerHTML = "", e.getComputedStyle && (s = M.createElement("div"), s.style.width = "0", s.style.marginRight = "0", p.style.width = "2px", p.appendChild(s), t.reliableMarginRight = 0 === (parseInt((e.getComputedStyle(s, null) || {marginRight: 0}).marginRight, 10) || 0)), p.attachEvent)for (f in{
            submit: 1,
            change: 1,
            focusin: 1
    ...
    H.fn.extend({
        attr: function (e, t) {
            ...
            if (e && "string" == typeof e)for (t = e.split(z), n = 0, r = this.length; r > n; n++)if (i = this[n], 1 === i.nodeType)if (i.className || 1 !== t.length) {
            ...
            if (e && "string" == typeof e || e === t)for (n = (e || "").split(z), r = 0, i = this.length; i > r; r++)if (o = this[r], 1 === o.nodeType && o.className)if (e) {
            ...
            return H.isFunction(e) ? this.each(function (n) {
                ...
                if ("string" === n)for (var i, o = 0, a = H(this), s = t, l = e.split(z); i = l[o++];)s = r ? s : !a.hasClass(i), a[s ? "addClass" : "removeClass"](i); else"undefined" !== n && "boolean" !== n || (this.className && H._data(this, "__className__", this.className), this.className = this.className || e === !1 ? "" : H._data(this, "__className__") || "")
            })
        }, hasClass: function (e) {
            for (var t = " " + e + " ", n = 0, r = this.length; r > n; n++)if (1 === this[n].nodeType && (" " + this[n].className + " ").replace(X, " ").indexOf(t) > -1)return !0;
            return !1
        }, val: function (e) {
            var n, r, i, o = this[0];
            {
        ...
        valHooks: {
            option: {
                ...
                get: function (e) {
                    ...
                    if (0 > o)return null;
                    for (n = l ? o : 0, r = l ? o + 1 : s.length; r > n; n++)if (i = s[n], i.selected && (H.support.optDisabled ? !i.disabled : null === i.getAttribute("disabled")) && (!i.parentNode.disabled || !H.nodeName(i.parentNode, "optgroup"))) {
        ...
        removeAttr: function (e, t) {
            var n, r, i, o, a = 0;
            if (t && 1 === e.nodeType)for (r = t.toLowerCase().split(z), o = r.length; o > a; a++)i = r[a], i && (n = H.propFix[i] || i, H.attr(e, i, ""), e.removeAttribute(Q ? i : n), Y.test(i) && n in e && (e[n] = !1))
        },
        attrHooks: {
            type: {
                set: function (e, t) {
                    if (U.test(e.nodeName) && e.parentNode)H.error("type property can't be changed"); else if (!H.support.radioValue && "radio" === t && H.nodeName(e, "input")) {
                        var n = e.value;
    ...
    }, Q || (R = {name: !0, id: !0}, I = H.valHooks.button = {
        get: function (e, n) {
            var r;
    ...
    var K = /^(?:textarea|input|select)$/i, Z = /^([^\.]*)?(?:\.(.+))?$/, ee = /\bhover(\.\S+)?\b/, te = /^key/, ne = /^(?:mouse|contextmenu)|click/, re = /^(?:focusinfocus|focusoutblur)$/, ie = /^(\w*)(?:#([\w\-]+))?(?:\.([\w\-]+))?$/, oe = function (e) {
        var t = ie.exec(e);
    ...
    H.event = {
        ...
        remove: function (e, t, n, r, i) {
            ...
            if (y && (d = y.events)) {
                for (t = H.trim(se(t || "")).split(" "), o = 0; o < t.length; o++)if (a = Z.exec(t[o]) || [], s = l = a[1], u = a[2], s) {
        ...
        dispatch: function (n) {
            ...
            if (m[0] = n, n.delegateTarget = this, h && !n.target.disabled && (!n.button || "click" !== n.type))for (a = H(this), a.context = this.ownerDocument || this, o = n.target; o != this; o = o.parentNode || this) {
        ...
        var d = function (e, t, n, i) {
            ...
            do if (r.exec(""), s = r.exec(N), s && (N = s[3], T.push(s[1]), s[2])) {
                c = s[3];
                break
            } while (s);
            if (T.length > 1 && m.exec(e))if (2 === T.length && h.relative[T[0]])l = w(T[0] + T[1], t, i); else for (l = h.relative[T[0]] ? [t] : d(T.shift(), t); T.length;)e = T.shift(), h.relative[e] && (e += T.shift()), l = w(e, l, i); else if (!i && T.length > 1 && 9 === t.nodeType && !x && h.match.ID.test(T[0]) && !h.match.ID.test(T[T.length - 1]) && (f = d.find(T.shift(), t, x), t = f.expr ? d.filter(f.expr, f.set)[0] : f.set[0]), t)for (f = i ? {
                expr: T.pop(),
                set: v(i)
            } : d.find(T.pop(), 1 !== T.length || "~" !== T[0] && "+" !== T[0] || !t.parentNode ? t : t.parentNode, x), l = f.expr ? d.filter(f.expr, f.set) : f.set, T.length > 0 ? u = v(l) : b = !1; T.length;)p = T.pop(), g = p, h.relative[p] ? g = T.pop() : p = "", null == g && (g = t), h.relative[p](u, g, x); else u = T = [];
        ...
        d.uniqueSort = function (e) {
            ...
            var r, i, o, a, s, l;
            if (!e)return [];
            for (i = 0, o = h.order.length; o > i; i++)if (s = h.order[i], (a = h.leftMatch[s].exec(e)) && (l = a[1], a.splice(1, 1), "\\" !== l.substr(l.length - 1) && (a[1] = (a[1] || "").replace(u, ""), r = h.find[s](a, t, n), null != r))) {
        ...
        try {
            ...
            v = function (e, t) {
                var n = 0, r = t || [];
                if ("[object Array]" === a.call(e))Array.prototype.push.apply(r, e); else if ("number" == typeof e.length)for (var i = e.length; i > n; n++)r.push(e[n]); else for (; e[n]; n++)r.push(e[n]);
                return r
            }
        }
        var x, T;
    ...
    var le = /Until$/, ue = /^(?:parents|prevUntil|prevAll)/, ce = /,/, fe = /^.[^:#\[\.,]*$/, de = Array.prototype.slice, pe = H.expr.match.POS, he = {
        children: !0,
        contents: !0,
        next: !0,
        prev: !0
    ...
    H.fn.extend({
        find: function (e) {
            ...
            if ("string" != typeof e)return H(e).filter(function () {
                for (t = 0, n = r.length; n > t; t++)if (H.contains(r[t], this))return !0
            });
            var i, o, a, s = this.pushStack("", "find", e);
            for (t = 0, n = this.length; n > t; t++)if (i = s.length, H.find(e, this[t], s), t > 0)for (o = i; o < s.length; o++)for (a = 0; i > a; a++)if (s[a] === s[o]) {
                s.splice(o--, 1);
                break
            }
            return s
            ...
            return this.filter(function () {
                for (var e = 0, n = t.length; n > e; e++)if (H.contains(this, t[e]))return !0
            })
        }, not: function (e) {
    ...
    Ae.optgroup = Ae.option, Ae.tbody = Ae.tfoot = Ae.colgroup = Ae.caption = Ae.thead, Ae.th = Ae.td, H.support.htmlSerialize || (Ae._default = [1, "div<div>", "</div>"]), H.fn.extend({
        ...
        clone: function (e, t, n) {
            ...
            if (!(H.support.noCloneEvent && H.support.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || H.isXMLDoc(e)))for (p(e, a), r = h(e), i = h(a), o = 0; r[o]; ++o)i[o] && p(r[o], i[o]);
            ...
            for (var o, a, s = [], l = 0; null != (a = e[l]); l++)if ("number" == typeof a && (a += ""), a) {
                if ("string" == typeof a)if (Te.test(a)) {
                    a = a.replace(ve, "<$1></$2>");
                    var u = (be.exec(a) || ["", ""])[1].toLowerCase(), f = Ae[u] || Ae._default, d = f[0], p = t.createElement("div");
                    for (t === M ? Le.appendChild(p) : c(t).appendChild(p), p.innerHTML = f[1] + a + f[2]; d--;)p = p.lastChild;
                    if (!H.support.tbody) {
                        var h = xe.test(a), m = "table" !== u || h ? "<table>" !== f[1] || h ? [] : p.childNodes : p.firstChild && p.firstChild.childNodes;
                ...
                var y;
                if (!H.support.appendChecked)if (a[0] && "number" == typeof(y = a.length))for (o = 0; y > o; o++)g(a[o]); else g(a);
                a.nodeType ? s.push(a) : s = H.merge(s, a)
            }
            if (n)for (i = function (e) {
                return !e.type || ke.test(e.type)
            }, l = 0; s[l]; l++)if (!r || !H.nodeName(s[l], "script") || s[l].type && "text/javascript" !== s[l].type.toLowerCase()) {
                if (1 === s[l].nodeType) {
    ...
    var je, Fe, De, Me = /alpha\([^)]*\)/i, Oe = /opacity=([^)]*)/, _e = /([A-Z]|^ms)/g, He = /^-?\d+(?:px)?$/i, Be = /^-?\d/, qe = /^([\-+])=([\-+.\de]+)/, Pe = {
        position: "absolute",
        visibility: "hidden",
        display: "block"
    }, We = ["Left", "Right"], Ie = ["Top", "Bottom"];
    ...
    Re = it.exec($e.toLowerCase()) || [], H.fn.extend({
        ...
        ajax: function (n, r) {
            function i(n, r, i, s) {
                if (2 !== w) {
                    ...
                    var c, d, b, x, T, k = r, S = i ? C(p, N, i) : t;
                    if (n >= 200 && 300 > n || 304 === n)if (p.ifModified && ((x = N.getResponseHeader("Last-Modified")) && (H.lastModified[o] = x), (T = N.getResponseHeader("Etag")) && (H.etag[o] = T)), 304 === n)k = "notmodified", c = !0; else try {
            ...
            var o, a, s, l, u, c, f, d, p = H.ajaxSetup({}, r), h = p.context || p, m = h !== p && (h.nodeType || h instanceof H) ? H(h) : H.event, g = H.Deferred(), y = H.Callbacks("once memory"), v = p.statusCode || {}, b = {}, x = {}, w = 0, N = {
                readyState: 0,
                ...
                getResponseHeader: function (e) {
                    var n;
                    if (2 === w) {
                        if (!s)for (s = {}; n = Ge.exec(a);)s[n[1].toLowerCase()] = n[2];
                        n = s[e.toLowerCase()]
                    }
                    return n === t ? null : n
                },
            ...
            if (g.promise(N), N.success = N.done, N.error = N.fail, N.complete = y.add, N.statusCode = function (e) {
                    if (e) {
                        var t;
                        if (2 > w)for (t in e)v[t] = [v[t], e[t]]; else t = e[N.status], N.then(t, t)
                    }
                    return this
            ...
            if (f = p.global, p.type = p.type.toUpperCase(), p.hasContent = !Qe.test(p.type), f && 0 === H.active++ && H.event.trigger("ajaxStart"), !p.hasContent && (p.data && (p.url += (Ze.test(p.url) ? "&" : "?") + p.data, delete p.data), o = p.url, p.cache === !1)) {
                var k = H.now(), S = p.url.replace(rt, "$1_=" + k);
            ...
            for (d in{success: 1, error: 1, complete: 1})N[d](p[d]);
            if (l = T(st, p, r, N)) {
        ...
        param: function (e, n) {
            ...
            }); else for (var o in e)N(o, e[o], n, i);
            ...
            return {
                send: function (i, o) {
                    ...
                    l.send(n.hasContent && n.data || null), r = function (e, i) {
                        var s, u, c, f, d;
                        try {
                            if (r && (i || 4 === l.readyState))if (r = t, a && (l.onreadystatechange = H.noop, pt && delete dt[a]), i)4 !== l.readyState && l.abort(); else {
    ...
    var mt, gt, yt, vt, bt = {}, xt = /^(?:toggle|show|hide)$/, Tt = /^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i, wt = [["height", "marginTop", "marginBottom", "paddingTop", "paddingBottom"], ["width", "marginLeft", "marginRight", "paddingLeft", "paddingRight"], ["opacity"]];
    H.fn.extend({
        show: function (e, t, n) {
            var r, i;
            ...
            function i() {
                ...
                var t, n, r, i, a, s, l, u, c, f = H.extend({}, o), d = 1 === this.nodeType, p = d && H(this).is(":hidden");
        ...
        update: function () {
            ...
            var t, n, r, i = vt || A(), o = !0, a = this.elem, s = this.options;
            if (e || i >= s.duration + this.startTime) {
                ...
                if (o) {
                    if (null == s.overflow || H.support.shrinkWrapBlocks || H.each(["", "X", "Y"], function (e, t) {
                        ...
                        }), s.hide && H(a).hide(), s.hide || s.show)for (t in s.animatedProperties)H.style(a, t, s.orig[t]), H.removeData(a, "fxshow" + t, !0), H.removeData(a, "toggle" + t, !0);
    ...
    var Nt = /^t(?:able|d|h)$/i, Ct = /^(?:body|html)$/i;
    "getBoundingClientRect" in M.documentElement ? H.fn.offset = function (e) {
        ...
        if (!t || !H.contains(o, n))return t ? {top: t.top, left: t.left} : {top: 0, left: 0};
        var a = i.body, s = D(i), l = o.clientTop || a.clientTop || 0, u = o.clientLeft || a.clientLeft || 0, c = s.pageYOffset || H.support.boxModel && o.scrollTop || a.scrollTop, f = s.pageXOffset || H.support.boxModel && o.scrollLeft || a.scrollLeft, d = t.top + c - l, p = t.left + f - u;
        return {top: d, left: p}
        ...
        position: function () {
            ...
            var e = this[0], t = this.offsetParent(), n = this.offset(), r = Ct.test(t[0].nodeName) ? {
                top: 0,
                left: 0
            } : t.offset();
...
function ajaxlogin(issynclogin, which, filename, callback, type, url, isopen) {
    var _login = {
        ...
        doLogin: function () {
            ...
            pageType = "", redirectURL = url || window.location.href, callback = "function" == typeof callback ? callback : function () {
            }, allowClose = !0, qyerUtil.doLogin({
                page: t,
                pageType: pageType,
...
function islogin(t, e, i) {
    ...
    var n = !1;
    return jQuery.ajax({
        url: o, dataType: "json", async: !1, success: function (i) {
...
function spam_text_filter() {
    ...
    jQuery(".qyer_spam_text_filter a").each(function () {
        ...
        if (null != i)for (var o = 0; o < i.length; o++)e = e.replace(i[o], "[imgimg]" + o + "[/imgimg]");
        if (e = e.replace(t, ""), null != i)for (var o = 0; o < i.length; o++)e = e.replace("[imgimg]" + o + "[/imgimg]", i[o]);
        jQuery(this).html(e)
    })
}
...
function getABFromGuid() {
    var t = new RegExp("(^| )_guid=([^;]*)(;|$)", "i"), e = document.cookie.match(t), i = "";
    if (null != e && e.length > 1 && (i = e[2]), "" == i)return "b";
    var o = i.substr(i.length - 1, 1).toLowerCase(), n = parseInt("0x" + o);
    return n > 7 ? "b" : "a"
}
...
function follow(t) {
    ...
    var i = t.attr("data-uid"), o = t.attr("data-relate"), n = t.attr("data-each"), a = "";
...
function tracker_request(t) {
    var e = encodeURIComponent(window.location.href), i = "http://qt.qyer.com/beacon.gif?type=click&category=" + encodeURIComponent(t) + "&campaign=inpage&", o = encodeURIComponent(document.referrer), n = jQuery.cookie("_guid") || "", a = jQuery.cookie("_uid") || "", s = jQuery.cookie("_session") || "";
...
function showFlash(t, e, i, o) {
    ...
    n += "<style>", n += ".popup_video_bg{background:url(http://static.qyer.com/images/plan2/popup_video_bg.png);}", n += "</style>", n += flash(e, i, o), jQuery("#" + t).html(n), qyerUI.popup.show({
        id: t,
        width: i
    }), jQuery(".ui_popup_bg").addClass("popup_video_bg"), jQuery(".ui_popup_close").css({top: -30, right: -30})
}
...
jQuery.postJSON = function (t, e, i) {
    return jQuery.ajax({type: "POST", url: t, data: e, dataType: "json", success: i})
};
var qyerUI = {version: "0.1"};
!function (t) {
    function e() {
    }
    ...
    function e() {
        return t("html").css({overflow: "", height: ""}), t("body").css({
            overflow: "",
            height: ""
    ...
    function i(e) {
        n && t("body").append(a), n = !1, t("html").css({
            ...
            display: "block",
            height: t(window).height()
        }), t(".ui_fullpupBox").css({width: e}), t(".ui_fullpupBox_main").text("")
    }

    var o = {}, n = !0, a = "<div class='ui_fullpupBox_bg'><div class='ui_fullpupBox'><div class='ui_fullpupBox_main'></div></div></div>";
    t(document).on("click", ".ui_fullpupBox_close", function () {
        e()
    }), o.ajax = function (e) {
        var o = e.url, n = e.width;
        i(n), t.get(o, function (e) {
            t(".ui_fullpupBox_main").html(e), t(".ui_fullpupBox_head").css({width: n})
        })
    }, o.show = function (e) {
        var o = e.id, n = e.width;
        i(n);
        var a = t("#" + o).html();
        t(".ui_fullpupBox_main").html(a), t(".ui_fullpupBox_head").css({width: n})
    }, qyerUI.fullpup = o
}(jQuery), function (t) {
    function e() {
    ...
    function i(i, o) {
        a && (t("body").append(s), t(".ui_popup_close").on("click", function () {
            e()
        })), a = !1, i = parseInt(i, 10), t(".ui_popup_bg").css({height: t(document).height()}).stop(!0, !0).fadeIn(300), t(".ui_popup").css({
            width: i,
    ...
    function o() {
        var e = t(window).height(), i = t(".ui_popup").height(), o = (e - i) / 2;
        o = 20 > o ? 20 : o, t(".ui_popup").css("margin-top", o)
    }

    var n = {}, a = !0, s = '<div class="ui_popup_bg"><div class="ui_popup"><p class="ui_popup_close" title="关闭"></p><div class="ui_popup_main"></div></div></div>';
    n.pupclose = e, n.start = i, n.ajax = function (e) {
        if ("object" == typeof e)var n = e.url, a = e.width || 500, s = e.isclose || "show", u = e.callback || !1;
        i(a, s), t.get(n, function (e) {
            t(".ui_popup_main").html(e), "function" == typeof u && u(), o()
        })
    }, n.show = function (e) {
        if ("object" == typeof e)var n = e.id, a = e.width || 500, s = e.isclose || "show";
        i(a, s);
        var u = t("#" + n).html();
        t(".ui_popup_main").html(u), o()
    }, n.showHtml = function (e) {
        if ("object" == typeof e)var n = e.html, a = e.width || 500, s = e.isclose || "show";
    ...
    var i = {}, o = !0, n = "<div class='ui_pupBox_bg'><div class='ui_pupBox'><div class='ui_pupBox_close'></div><div class='ui_pupBox_main'></div></div></div>";
    window.pupclose = t, i.start = e, i.ajax = function (i, o, n) {
        var a = "show", s = typeof i;
    ...
    function e(e) {
        if ("object" == typeof e) {
            var o = e.msg || "操作已成功！", n = e.type || "true", a = e.timeout || 2e3;
            clearTimeout(i);
            var s = document.getElementById("mod_message"), u = document.getElementById("mod_message_cont");
            if (!s) {
            ...
            var l = s.offsetWidth, p = document.body.offsetWidth, d = (p - l) / 2;
...
popup.coast = function (t, e, i, o) {
    ...
    var s = jQuery(window).width(), u = jQuery(window).height(), r = jQuery(".ui_coast").outerHeight(), c = t + 42, l = (s - c) / 2, p = (u - r) / 2 + jQuery(document).scrollTop(), d = 10;
    if (e)if (e = jQuery("#" + e), e.size() > 0) {
        var h = e.offset(), _ = e.outerWidth(), f = e.outerHeight(), m = h.top - r - d, y = h.left - (c - _) / 2;
        c > s - _ - y + d ? (y = s - c - d, h.top - jQuery(document).scrollTop() < r ? (m = h.top + f + d, jQuery(".ui_coast").css({
            ...
            left: y,
            top: m
        }).show()) : (10 > y && (y = 10), jQuery(".ui_coast").css({width: t, left: y, top: m}).show())
    } else jQuery(".ui_coast").css({width: t, left: l, top: p}).show(); else jQuery(".ui_coast").css({
        width: t,
        left: l,
        top: p
    }).show();
...
var tips = function () {
    var t = function () {
        this.isshow = !1, this.html = ["<div class='ui_message __XXtipsXX_' >", "", "</div>"], this.scroll_show = function () {
        }, this.show = function (t, e) {
            t = t || "", e = e || 2e3;
            var i = this.getobj();
            return this.isshow ? (jQuery(i).css({left: jQuery(document).width() / 2 - 200}), jQuery.browser.msie && "6.0" == jQuery.browser.version && jQuery(i).css({top: jQuery(document).scrollTop()}), void i.html(t)) : (this.html[1] = t, jQuery("body").append(this.html.join("")), i = this.getobj(), jQuery(i).css({left: jQuery(document).width() / 2 - 200}), jQuery.browser.msie && "6.0" == jQuery.browser.version && jQuery(i).css({top: jQuery(document).scrollTop()}), i.show(), this.isshow = !0, void setTimeout(function () {
    ...
    t.prototype.confirm = function (t, e, i) {
        void 0 == i && (i = "您确定要删除吗？");
        var o = t.clientX, n = t.clientY, a = "jsdelconfirm", s = ['<div class="ui_delete" id="' + a + '">', '<div class="ui_delete_box">', '<div><span class="icon_doubt">' + i + "</span></div>", '<div class="ui_delete_btns">', '<input type="button" value="取消" class="ui_button_cancel" id="jsconfirmcancel" /><input type="button" id="jsconfirmok" value="确定" class="ui_button" />', "</div>", "</div>", "</div>"], u = jQuery("#" + a);
        u.size() <= 0 ? (jQuery("body").append(s.join("")), u = jQuery("#" + a)) : jQuery(u).find(".icon_doubt").html(i);
        var r = 91, c = jQuery(document).scrollTop() + n - 100;
        jQuery(u).css("top", c + "px");
        var l = jQuery(".ui_delete").width(), p = o, d = jQuery(document).scrollLeft();
        l > o - d || (p = o - l / 2);
        ...
        p + l > h && (p = h - l - 20), 0 >= p && (p = 20), jQuery(u).hide(), jQuery(u).css({
            ...
            jQuery(u).animate({height: "hide", opacity: "hide", top: c + r}, 200)
        }), jQuery("#jsconfirmok").unbind("click").click(function (t) {
            e(), jQuery(u).animate({height: "hide", opacity: "hide", top: c + r}, 200)
        })
    };
    var e = new t;
    ...
    ajaxurl: "/ajax.php", get: function (t, e, i) {
        var o = +new Date;
        ...
        e = jQuery.merge(e, {type: "POST"}), jQuery.post(_ajax.ajaxurl + "?action=" + t, e, i)
    }
};
String.prototype.gbtrim = function (t, e) {
    ...
    var t = jQuery(".auto_text").size() > 0, e = function () {
        jQuery("body").append("<textarea id='auto_text_shadow' style='display:block;'></textarea>")
    };
    t && e();
    var i = function (t) {
        jQuery(".auto_text").size() && e();
        var i = t || jQuery(".auto_text"), o = "auto_text_shadow", n = jQuery("#" + o);
        if (o != jQuery(i).attr("id")) {
            jQuery(n).width(jQuery(i).width());
            var a = jQuery(i).css("font-size"), s = jQuery(i).css("line-height"), u = jQuery(i).css("text-indent"), r = parseInt(jQuery(i).css("min-height").replace(/px/, ""));
            r = s, jQuery(n).css({height: "18px", "font-size": a, "text-indent": u});
...
jQuery(function () {
    ...
    jQuery("._js_jiathis_style_share a").mouseover(function () {
        ...
        var t = jQuery(this), e = t.attr("data-title"), i = t.attr("data-summary"), o = t.attr("data-pic"), n = t.attr("data-url") || "";
    ...
    var e, i = jQuery(".photo_end_share_btn"), o = jQuery(".bbs_tools_sharelay");
    i.hover(function () {
    ...
    jQuery(document).on("click", "._js_follow_func", function () {
        ...
        if (QYER.uid <= 0)return ajaxlogin(), !1;
        var t = jQuery(this).attr("data-uid"), e = jQuery(this).attr("data-relate");
    ...
    qyerUI = window.qyerUI || {}, qyerUI.SNS = qyerUI.SNS || {}, qyerUI.SNS.share = {
        _init: function () {
            ...
            var e = [], t = t || {}, i = t.weibopublish || {}, o = t.qqpublish || {};
            ...
            if (i.is(":checked")) {
                ...
                if ("0" == i.attr("flag")) {
                    var o = i.attr("weibo"), n = i.attr("id"), a = i.attr("notoken");
    ...
    window.qyerUtil || (window.qyerUtil = {
        ...
        }, _showAntiSpam_isLoadCss_: !1, showAntiSpam: function (e) {
            function i(t) {
