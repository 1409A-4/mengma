...
$(function () {
    ...
    $('#min').click(function () {
        ...
        $('#sum').html(price*this_nump + roomc*1);
    ...
    $('#rin').click(function () {
        ...
        if( this_numr < numrs ){
            ...
            $('#tip').show(100).delay(100).hide(100);
        }

        $('#numr').val(this_numr);
        all = $('#all').html(nump*price + (this_numr*2-nump)*300);
      $('#sum').html(nump*price + (this_numr*2-nump)*300);
