...
Route::group(['prefix'=>'login'],function() {
    ...
    Route::get('jump','Index\LoginController@jump');//自动跳转登录
    Route::post('regiswei','Index\LoginController@RegisWeixin');//微信注册

    Route::get('loginout','Index\LoginController@loginout');//退出
   // Route::get('retrieve','Index\LoginController@');//找回密码

});


Route::group(['prefix'=>'index','middleware'=>'my'],function(){
    ...
    Route::get('myself','Index\AlreadyController@hauorders');//用户中心 订单
    Route::get('lookorder','Index\AlreadyController@horderds');//用户中心    查看订单
    Route::get('delorder','Index\AlreadyController@delorder');//用户中心    删除订单
