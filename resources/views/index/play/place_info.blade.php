...
<div class="lmMain">
    <div class="grand-title clearfix">
        <h1 style="visibility: visible;" class="title-text fontYaHei">{{$data['pro_name']}}</h1>
        <p class="normal-price">
            <span class="former-price">¥1999</span>
            <span class="after-price"><em>{{ $data['pro_price'] }}</em>元起</span>
        </p>
    </div>
    <!-- 表单  -->
    <form id="lastminuteorderform" name="lastminuteorderform" action="package" method="POST" str="0">
        <input type="hidden" name="_token" value="{{ csrf_token() }}">
        <input type="hidden" name="p_id" value="{{ $data['pro_id'] }}">
                ...
                <div class="gallery">
                    ...
                    <div class="scroll-unit">
                        <div data-canslide="false" class="img-scroll clearfix">
                            <div class="scroll-cell"><img src="{{ $data['pro_img'] }}"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="content-wrap">
                    <div class="content-unit product-option">
                        ...
                        <div class="unit-nr">
                            ...
                            <ul class="type-list clearfix" data-orheight="144">
                                @foreach($type as $ty)
                                    <li class="first pri" data-pid="219425" data-type="{{ $ty['prt_id'] }}" data-bn-ipg="lm-detail-type-219425" >
                                        <p >{{ $ty['prt_name'] }}（<span>{{ $ty['prt_price'] }}</span>元）</p>
                                    </li>
                                @endforeach
                    ...
                    <div class="content-unit lm-calendar">
                        <h4 class="unit-title">出发日期
                            <span class="title-desc"><input id="d422" name="go_time" class="Wdate" type="text" onfocus="WdatePicker({minDate:'%y-%M-{%d+3}'})"/> </span>&nbsp;&nbsp;&nbsp;&nbsp;<span style="color: red">请至少提前3天预订</span>
                    ...
                    <div class="content-unit person-number">
                        ...
                        <div class="unit-nr">
                            <ul class="person-list clearfix">
                                <li>
                                    <p class="num-p">
                                        <span class="mun-text">数量</span>
                                        <a class="num-btn minus min" data-bn-ipg="lm-paydetail-adult-increase"
                                        ...
                                        <a class="num-btn add max" data-bn-ipg="lm-paydetail-adult-decrease" href="javascript:void(0);">
...
<script>
    $(function () {
        ...
        var price = $('.pri').eq(0).children().children().html();
        $('#all').html(parseInt(price) + parseInt(room));
        $('#sum').html(parseInt(price) + parseInt(room));
        $('#room').html(numr*room);


        $('.type-list li:eq(0)').addClass('active');
        var t_id = $('.pri.active').attr('data-type');
        ...
        $('.min').click(function () {
            ...
            $('#all').html(price*this_nump );
            $('#sum').html(price*this_nump );
